...
function [net, tr] = ANNCrossValidationLoop(X,y, tr, ts, layers) % %Tr is training indices %Ts is testing indices
...
net = fitnet(hiddenlayersize); %This is the bayesian trainer, more complex 
